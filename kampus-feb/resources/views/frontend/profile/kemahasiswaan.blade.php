...
@section('title', 'Kemahasiswaan - Fakultas Ekonomi dan Bisnis')
...
<div class="relative bg-slate-900 text-white pt-6 pb-16 overflow-hidden border-b border-white/5 font-poppins">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <nav class="w-full flex items-center text-sm font-medium mb-10 font-poppins">
            ...
            <span class="text-orange-500 font-semibold cursor-default">Kemahasiswaan</span>
        </nav>
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div class="text-left"> 
                <h1 class="text-4xl md:text-6xl font-extrabold mb-4 tracking-tight leading-tight uppercase font-poppins">
                    Pusat <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Kemahasiswaan</span>
                </h1>
                ...
                <p class="text-lg text-slate-300 font-light leading-relaxed max-w-lg font-poppins">
                    Wadah pengembangan diri, kreativitas, dan pencapaian prestasi mahasiswa di tingkat regional, nasional, maupun internasional.
                </p>
            </div>
            ...
            <div class="hidden md:block relative h-[280px] flex items-center justify-center perspective-1000">
                ...
                <div class="relative w-72 bg-slate-800/40 backdrop-blur-xl border border-white/10 p-6 rounded-2xl shadow-2xl transform -rotate-y-6 hover:rotate-y-0 transition-transform duration-700">
                    <div class="bg-gradient-to-br from-slate-700/50 to-slate-800/50 h-32 rounded-xl mb-4 flex items-center justify-center border border-white/5 group">
                        <i class="fas fa-user-graduate text-5xl text-slate-500 group-hover:text-orange-500 transition-all duration-500 transform group-hover:scale-110"></i>
                    </div>

                    <div class="space-y-3">
                        <div class="flex justify-between items-end mb-1">
                            <div class="h-1.5 bg-orange-500 rounded-full w-2/3"></div>
                            <span class="text-[10px] text-orange-500 font-bold leading-none font-poppins">90% Skill</span>
                        </div>
                ...
                <div class="absolute -top-6 right-6 bg-slate-800/95 backdrop-blur-md border border-orange-500/30 p-4 rounded-2xl shadow-xl animate-bounce" style="animation-duration: 3s;">
                    <div class="flex flex-col items-center">
                        ...
                        <span class="text-[10px] font-bold text-white tracking-wider uppercase font-poppins">Achievement</span>
                    </div>
                </div>
                ...
                <div class="absolute -bottom-6 left-6 bg-slate-800/90 backdrop-blur-md border border-blue-500/30 p-3 rounded-xl shadow-xl animate-bounce" style="animation-duration: 4s;">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[9px] text-slate-400 uppercase leading-none mb-1 tracking-tighter font-poppins">Organisasi</p>
                            <p class="text-xs font-bold text-white leading-none font-poppins">Aktif & Kreatif</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-4 space-y-8">
                    <div class="sticky top-24" style="position: -webkit-sticky; position: sticky;">
                        <div class="relative bg-white p-2 rounded-2xl shadow-lg border border-gray-100 transform hover:-translate-y-1 transition-transform duration-300 group">
                            ...
                            @if($kemahasiswaan->photo_url)
                                <div class="relative overflow-hidden rounded-xl">
                                    <img src="{{ $kemahasiswaan->photo_url }}" 
                                         alt="Kemahasiswaan" 
                                         class="w-full h-auto object-contain">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                    <div class="absolute bottom-4 left-4 text-white">
                                        <p class="text-xs font-bold uppercase tracking-widest text-orange-400 mb-1 font-poppins">Kemahasiswaan</p>
                            ...
                            @else
                                <div class="bg-gradient-to-br from-orange-50 to-red-50 h-64 rounded-xl flex items-center justify-center text-gray-400">
                                    <div class="text-center">
                                        <i class="fas fa-user-graduate text-6xl text-orange-300 mb-3"></i>
                                        <p class="text-sm font-semibold text-orange-400 font-poppins">Kemahasiswaan FEB</p>
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            ...
                            <h2 class="text-3xl md:text-4xl font-bold text-[#1a1a2e] mb-8 leading-tight font-poppins">
                                {{ $kemahasiswaan->name ?? 'Kemahasiswaan' }}
                            </h2>

                            @if($kemahasiswaan->content)
                            ...
                            @else
                                <div class="flex flex-col items-center justify-center py-16 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                                    ...
                                    <p class="text-gray-500 font-medium font-poppins">Konten kemahasiswaan belum tersedia saat ini.</p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="grid md:grid-cols-3 gap-5 mt-10 pt-10 border-t border-gray-100">
                            <div class="text-center p-4 rounded-lg bg-gray-50 hover:bg-orange-50 transition-colors duration-300 group">
                                ...
                                <h4 class="font-bold text-gray-800 text-sm font-poppins">Organisasi Mahasiswa</h4>
                            </div>
                            <div class="text-center p-4 rounded-lg bg-gray-50 hover:bg-orange-50 transition-colors duration-300 group">
                                <i class="fas fa-trophy text-2xl text-[#1a1a2e] mb-3 group-hover:text-orange-500 transition-colors"></i>
                                <h4 class="font-bold text-gray-800 text-sm font-poppins">Prestasi & Kompetisi</h4>
                            </div>
                            <div class="text-center p-4 rounded-lg bg-gray-50 hover:bg-orange-50 transition-colors duration-300 group">
                                <i class="fas fa-hands-helping text-2xl text-[#1a1a2e] mb-3 group-hover:text-orange-500 transition-colors"></i>
                                <h4 class="font-bold text-gray-800 text-sm font-poppins">Pengabdian Masyarakat</h4>
                            </div>
                        </div>
        ...
        @else
            <div class="max-w-lg mx-auto text-center py-20">
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <p class="text-gray-500 mb-6 font-poppins">Informasi Kemahasiswaan sedang dalam proses pembaruan oleh administrator.</p>
