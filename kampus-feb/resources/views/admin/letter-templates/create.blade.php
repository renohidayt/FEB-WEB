...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 fw-bold text-dark mb-1">Buat Template Surat Baru</h1>
    ...
    <form action="{{ route('admin.letter-templates.store') }}" method="POST" id="templateForm">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Misal: Surat Izin Penelitian" 
                                   required>
                            @error('title')
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Jelaskan fungsi surat ini untuk mahasiswa...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
                        <h6 class="m-0 fw-bold text-dark">
                            <i class="fas fa-list-alt me-2 text-primary"></i>Formulir Isian Mahasiswa
                        </h6>
                        ...
                        <div class="mt-3">
                            ...
                            <div id="addMenuContainer" class="d-none mt-3 p-3 bg-white border rounded shadow-sm">
                                ...
                                <div class="row g-2">
                                    @php
                                        $menuItems = [
                                            ['text', 'fas fa-font', 'Teks Singkat', 'Nama, Tempat Lahir'],
                                            ['textarea', 'fas fa-align-left', 'Paragraf', 'Alamat, Alasan'],
                                            ['number', 'fas fa-hashtag', 'Angka', 'No HP, Tahun'],
                                            ['date', 'fas fa-calendar', 'Tanggal', 'Tanggal Lahir/Acara'],
                                            ['select', 'fas fa-chevron-circle-down', 'Dropdown', 'Pilihan Menu'],
                                            ['radio', 'fas fa-dot-circle', 'Radio Button', 'Pilihan Tunggal'],
                                            ['checkbox', 'fas fa-check-square', 'Checkbox', 'Pilihan Jamak'],
                                            ['file', 'fas fa-upload', 'Upload File', 'PDF, Gambar'],
                                        ];
                                    @endphp
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch p-0 ps-5">
                            ...
                            <label class="form-check-label fw-bold pt-1" for="isActive">Langsung Aktifkan?</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0 mb-4 bg-info bg-opacity-10">
                    <div class="card-body">
                        <div class="d-flex gap-2 mb-2 text-primary">
                            <i class="fas fa-magic fs-5"></i>
                            <h6 class="fw-bold m-0">Data Otomatis</h6>
                        </div>
                        <p class="small text-dark mb-2">Data berikut akan terisi otomatis dari sistem (Tidak perlu dibuatkan kolom):</p>
                        <div class="d-flex flex-wrap gap-1">
                            @foreach(['Nama Lengkap', 'NIM', 'Prodi', 'Semester'] as $dt)
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div id="approvalFields" style="display: none;" class="bg-light p-3 rounded border">
                            <div class="mb-2">
                                <label class="form-label small fw-bold">Jabatan Pejabat</label>
                                <input type="text" name="approval_title" class="form-control form-control-sm" placeholder="Contoh: Dekan Fakultas X">
                            </div>
                            <div class="mb-2">
                                <label class="form-label small fw-bold">Nama Lengkap</label>
                                <input type="text" name="approval_name" class="form-control form-control-sm" placeholder="Nama + Gelar">
                            </div>
                            <div class="mb-0">
                                <label class="form-label small fw-bold">NIP / NIDN</label>
                                <input type="text" name="approval_nip" class="form-control form-control-sm">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {{-- Hidden Input untuk JSON Fields --}}
...
// 1. Toggle Menu Tambah (Manual JS)
    ...
    if (fields.length === 0) {
        container.innerHTML = `
            <div class="text-center py-5 border rounded bg-white">
                ...
                <h6 class="text-dark fw-bold">Formulir Masih Kosong</h6>
                <p class="text-muted small">Silakan klik tombol "Tambah Kolom" di bawah untuk memulai.</p>
            </div>`;
        updateFormFieldsJson();
        return;
    }
            ...
            <div class="card-body p-3">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between mb-2">
                            <input type="text" 
                                   ...
                                   placeholder="Tulis Judul Pertanyaan Disini...">
                        ...
                        <div class="mb-2">
                             <input type="text" 
                                   ...
                                   placeholder="Placeholder / Petunjuk pengisian...">
                        </div>
                    ...
                    <div class="d-flex flex-column gap-2 border-start ps-2">
                        ...
                        <button type="button" onclick="deleteField(${field.id})" class="btn btn-sm text-danger hover-danger p-0" title="Hapus">
...
function toggleApprovalFields() {
    ...
    const panel = document.getElementById('approvalFields');
    if(box && panel) {
...
<style>
/* CSS Utility agar tampilan konsisten */
