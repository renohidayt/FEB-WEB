...
<div class="px-3 py-3">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h1 class="h4 fw-bold mb-1">Edit Berita</h1>
            <p class="text-muted small mb-0">Update: <strong>{{ $news->title }}</strong></p>
        </div>
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Saat ini: <strong>{{ $news->author_display_name }}</strong></small>
                                @error('author_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="excerpt" 
                                      ...
                                      placeholder="Tulis ringkasan singkat...">{{ old('excerpt', $news->excerpt) }}</textarea>
                ...
                <div class="card shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold small">Gambar Unggulan Saat Ini</label>
                            <div class="card bg-light border-0" id="currentImageDisplay">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <img src="{{ asset('storage/' . $news->featured_image) }}" 
                                                 ...
                                                 style="width: 150px; height: 100px; object-fit: cover; transition: opacity 0.3s;">
                                        </div>
                                        <div class="col">
                                            <span class="badge bg-success mb-1">Ada Gambar</span>
                                            <p class="small text-muted mb-0">Upload gambar baru di bawah untuk mengganti</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold small">
                                {{ $news->featured_image ? 'Ganti Gambar Unggulan' : 'Upload Gambar Unggulan' }}
                            </label>
                            <div class="border border-2 border-dashed rounded p-4 text-center bg-light" style="cursor: pointer;" onclick="document.getElementById('featured_image').click()">
                                ...
                                <p class="mb-1 fw-semibold">Klik untuk {{ $news->featured_image ? 'mengganti' : 'upload' }} gambar</p>
                            ...
                            <div id="imagePreview" class="mt-3 d-none">
                                ...
                                <div class="position-relative d-inline-block">
                                    <img id="preview" src="" alt="Preview" class="image-preview border border-2 border-success shadow-sm">
                        ...
                        <div class="card bg-light border-0">
                            <div class="card-body p-3">
                                <label class="form-label fw-bold small">Galeri Foto</label>
                                ...
                                @if($news->images && $news->images->count() > 0)
                                    <div class="mb-3">
                                        <p class="small text-muted mb-2">
                                            ...
                                            Galeri Saat Ini ({{ $news->images->count() }} foto)
                                        </p>
                                        <div class="gallery-preview">
                                            @foreach($news->images as $image)
                                            <div class="gallery-item">
                                                <span class="badge bg-success position-absolute top-0 start-0 m-2" style="font-size: 0.65rem; z-index: 1;">
                                                    Tersimpan
                                                </span>
                                                <img src="{{ asset('storage/' . $image->image_path) }}" alt="Gallery Image">
                                                <div class="p-2">
                                                    <p class="small text-muted mb-2 text-truncate" style="font-size: 0.75rem;">
                                                        {{ $image->caption ?: 'Tanpa caption' }}
                                                    </p>
                                                    <div class="form-check">
                                                        <input type="checkbox" name="delete_images[]" value="{{ $image->id }}" 
                                                               class="form-check-input" id="delete{{ $image->id }}">
                                                        <label class="form-check-label text-danger" style="font-size: 0.75rem;" for="delete{{ $image->id }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="meta_description" rows="2" maxlength="160" 
                                      ...
                                      placeholder="Deskripsi untuk mesin pencari">{{ old('meta_description', $news->meta_description) }}</textarea>
                ...
                <div class="card shadow-sm sticky-sidebar">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card bg-light border-0 mb-3">
                            <div class="card-body p-3">
                                <h6 class="fw-bold small mb-2 text-info">
                                    <i class="fas fa-chart-line me-1"></i> Statistik
                                </h6>
                                <p class="small text-muted mb-1"><strong>Views:</strong> {{ $news->views ?? 0 }}</p>
                                <p class="small text-muted mb-1"><strong>Dibuat:</strong> {{ $news->created_at->format('d M Y') }}</p>
                                <p class="small text-muted mb-0"><strong>Update:</strong> {{ $news->updated_at->diffForHumans() }}</p>
                            </div>
                        </div>
