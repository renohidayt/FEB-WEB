...
<div class="container-fluid px-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 mt-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">Edit Data Jurnal</h1>
            <p class="text-muted small mb-0">Update informasi jurnal: <strong>{{ $journal->name }}</strong></p>
        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" 
                                              ...
                                              placeholder="Deskripsi singkat tentang jurnal ini">{{ old('description', $journal->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="manager" class="form-select @error('manager') is-invalid @enderror" required>
                                        ...
                                        <option value="Fakultas Ekonomi dan Bisnis" {{ old('manager', $journal->manager) == 'Fakultas Ekonomi dan Bisnis' ? 'selected' : '' }}>Fakultas Ekonomi dan Bisnis</option>
                                        <option value="Prodi Manajemen" {{ old('manager', $journal->manager) == 'Prodi Manajemen' ? 'selected' : '' }}>Prodi Manajemen</option>
                                        <option value="Prodi Akuntansi" {{ old('manager', $journal->manager) == 'Prodi Akuntansi' ? 'selected' : '' }}>Prodi Akuntansi</option>
                                        <option value="Prodi Magister Manajemen" {{ old('manager', $journal->manager) == 'Prodi Magister Manajemen' ? 'selected' : '' }}>Prodi Magister Manajemen</option>
                                    </select>
                                    @error('manager')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="accreditation_status" class="form-select @error('accreditation_status') is-invalid @enderror">
                                        ...
                                        @foreach($accreditationStatuses as $key => $label)
                                            <option value="{{ $key }}" {{ old('accreditation_status', $journal->accreditation_status) == $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" 
                                               ...
                                               value="{{ old('website_url', $journal->website_url) }}" 
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" 
                                               ...
                                               value="{{ old('submit_url', $journal->submit_url) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" 
                                               ...
                                               value="{{ old('sinta_url', $journal->sinta_url) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" 
                                               ...
                                               value="{{ old('garuda_url', $journal->garuda_url) }}" 
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" 
                                               ...
                                               value="{{ old('scholar_url', $journal->scholar_url) }}" 
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('frequency', $journal->frequency) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('editor_in_chief', $journal->editor_in_chief) }}" 
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <div class="form-text text-muted small">
                                        Format: JPG, PNG. Maksimal 2MB. Minimal 300x400px. Rasio 3:4 direkomendasikan.
                                        @if($journal->cover_image)
                                        <strong class="text-warning">Upload cover baru akan mengganti cover lama.</strong>
                                        @endif
                                    </div>
                                    @error('cover_image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" 
                                                       ...
                                                       name="is_visible" 
                                                       value="1" 
                                                       {{ old('is_visible', $journal->is_visible) ? 'checked' : '' }}>
